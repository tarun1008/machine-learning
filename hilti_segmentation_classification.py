...
data = pd.read_csv('CustomerSegmentationData.csv', nrows=100)
#print(data)
#print(data.describe())
...
feature_names = ['AccountScore', 'Complexity', 'CustomerID', 'DeviceRating', 'EquipmentPrice', 'MonthlyMaintenance', 'ProductWeight', 'UsagePerDay', 'transformedProductCategory']
